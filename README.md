...
| Command                        | Description                                                                                                                                             |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `mpvd list [file]` (`ls`)      | Show the current playlist or XSPF playlist file if provided (`--plain` for raw names, `--full` for absolute paths, `--interactive` for interactive TUI) |
